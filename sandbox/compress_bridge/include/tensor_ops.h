...
void vec_axpy(float* y, const float* x, float a, int n); // y = a*x + y
void vec_rescale_and_add(float* dst, const float* src, float rescale, float weight, int n); // dst = dst*rescale + src*weight
